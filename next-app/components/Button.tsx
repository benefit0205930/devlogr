...
export default function Button({
  ...
  const baseStyles =
    'inline-flex items-center justify-center font-medium transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed'
  ...
  const variants = {
    ...
    darkOutline:
      'border-2 border-white bg-transparent text-white hover:bg-white hover:text-gray-900 focus:ring-white',
    ...
    accent:
      'bg-[var(--color-brand-primary)] text-white hover:bg-[var(--color-brand-primary-dark)] focus:ring-[var(--color-brand-primary)]',
  }
